		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/userAdmin_update.action" method="post" >
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgcolor="#ffffff">
						<input type="radio" <s:if test="model.state==10">checked="checked"</s:if> name="state" value="10"  />  普通用户
						<input type="radio" <s:if test="model.state==20">checked="checked"</s:if> name="state" value="20"  />   商家用户
						<%--<s:radio list="#{'10':'普通用户','20':'商家用户'}" name="state" value="#{model.state}" id="userAction_save_do_logonName" class="bg"/>--%>
					</td>
				</tr>
