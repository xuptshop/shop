			...
			<form id="orderForm" action="${ pageContext.request.contextPath }/order_payOrder.action" method="post">
				...
				<div class="span24">
					<p>
						...
						<p>
							选择支付方式：
							<input type="radio" name="pay-type" value="alipay-pay" checked="checked"/>支付宝支付&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="pay-type" value="wechat-pay"/>微信支付&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="pay-type" value="offline-pay"/>线下支付
						</p>
						<br>
						<hr />
