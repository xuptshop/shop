					...
					<table>
						...
						<tr>
							<div>
								<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" onclick="changeCommonUser()" name="regist-type" value="commonUser" checked="checked">普通用户
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" onclick="changeMerchant()" name="regist-type" value="merchantUser">商家用户
							</div>
						</tr>
						<tr>
							<th id="common">
						...
						<tr class="register">
							...
							<td>
								<dl>
									...
									<dd>
										是商家账号或者管理员？
										<a href="${ pageContext.request.contextPath }/adminUser_index.action">后台管理页面登录</a>
									</dd>
								</dl>
							</td>
						</tr>
