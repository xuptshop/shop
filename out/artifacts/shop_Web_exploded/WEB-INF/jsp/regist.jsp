				...
				<form id="registerForm" action="${ pageContext.request.contextPath }/user_regist.action"  method="post" novalidate="novalidate" onsubmit="return checkForm();">
					<table>
						...
						<tr>
							...
							<th id="merchant" style="display: none">
						...
						<tr>
							<div>
								<br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" onclick="changeCommonUser()" name="regist-type" value="commonUser" checked="checked">普通用户注册&nbsp;&nbsp;
								<input type="radio" onclick="changeMerchant()" name="regist-type" value="merchantUser">商家账号注册
							</div>
						</tr>
						<tr>
							<th>&nbsp;
...
<div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;"><iframe style="width: 190px; height: 191px;" frameborder="0" border="0" scrolling="no"></iframe></div></body></html>